    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2023, 9, 22, 20, 14, 32, 93, DateTimeKind.Local).AddTicks(1924), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2023, 9, 25, 20, 14, 32, 94, DateTimeKind.Local).AddTicks(1438), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2023, 9, 29, 20, 14, 32, 94, DateTimeKind.Local).AddTicks(1463), "Celebrating a birthday." }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Tasty Vada Pav", "Vada Pav", 20.0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "Name", "Price" },
                values: new object[] { "Tasty Samosa", "Samosa", 25.0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "Name", "Price" },
                values: new object[] { "Tasty Sada Dosa", "Sada Dosa", 30.0 });

            migrationBuilder.InsertData(
                table: "Menus",
                columns: new[] { "Id", "Description", "Name", "Price" },
                values: new object[] { 4, "Tasty Masala Dosa", "Masala Dosa", 50.0 });
        }
    }
}
